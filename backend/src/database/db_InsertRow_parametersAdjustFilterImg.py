...
class Insert_parametersAdjustFilterImg():
    def salvar():
        ...
        #Area
        SpliceLineJumpWhiteVer_JumpSize_Field_X = controllers.varGlobal.adjustmentPanel.var_parametersFilter_SpliceLineJumpWhiteVer_JumpSize_Field_X
        SpliceLineJumpWhiteVer_JumpSize_Field_Y = controllers.varGlobal.adjustmentPanel.var_parametersFilter_SpliceLineJumpWhiteVer_JumpSize_Field_Y
        ...
        #Area
        SpliceLineJumpWhiteHor_JumpSize_Field_X = controllers.varGlobal.adjustmentPanel.var_parametersFilter_SpliceLineJumpWhiteHor_JumpSize_Field_X
        SpliceLineJumpWhiteHor_JumpSize_Field_Y = controllers.varGlobal.adjustmentPanel.var_parametersFilter_SpliceLineJumpWhiteHor_JumpSize_Field_Y
        ...
        #Area
        SpliceLineJumpBlackVer_JumpSize_Field_X = controllers.varGlobal.adjustmentPanel.var_parametersFilter_SpliceLineJumpBlackVer_JumpSize_Field_X
        SpliceLineJumpBlackVer_JumpSize_Field_Y = controllers.varGlobal.adjustmentPanel.var_parametersFilter_SpliceLineJumpBlackVer_JumpSize_Field_Y
        ...
        #Area
        SpliceLineJumpBlackHor_JumpSize_Field_X = controllers.varGlobal.adjustmentPanel.var_parametersFilter_SpliceLineJumpBlackHor_JumpSize_Field_X
        SpliceLineJumpBlackHor_JumpSize_Field_Y = controllers.varGlobal.adjustmentPanel.var_parametersFilter_SpliceLineJumpBlackHor_JumpSize_Field_Y
        ...
        with mysql.cursor() as cur:
            ...
            if (res is None):
                ...
                print("INSERT INTO parametersAdjustFilterImg VALUE"
                            "(0, %s, "
                            "%s, %s, "
                            "%s, %s, "
                            "%s, %s, "
                            ...
                            SpliceLineJumpWhiteVer_JumpSize_Field_X     , SpliceLineJumpWhiteVer_JumpSize_Field_Y   ,
                            SpliceLineJumpWhiteHor_JumpSize_Min         , SpliceLineJumpWhiteHor_JumpSize_Max       , 
                            SpliceLineJumpWhiteHor_JumpSize_Field_X     , SpliceLineJumpWhiteHor_JumpSize_Field_Y   ,
                            SpliceLineJumpBlackVer_JumpSize_Min         , SpliceLineJumpBlackVer_JumpSize_Max       ,
                            SpliceLineJumpBlackVer_JumpSize_Field_X     , SpliceLineJumpBlackVer_JumpSize_Field_Y   ,
                            SpliceLineJumpBlackHor_JumpSize_Min         , SpliceLineJumpBlackHor_JumpSize_Max       ,
                            SpliceLineJumpBlackHor_JumpSize_Field_X     , SpliceLineJumpBlackHor_JumpSize_Field_Y   ,
                ...
                cur.execute("UPDATE parametersAdjustFilterImg SET "
                            ...
                            "SpliceLineJumpWhiteVer_JumpSize_Field_X    = %s , SpliceLineJumpWhiteVer_JumpSize_Field_Y      = %s ,  "
                            "SpliceLineJumpWhiteHor_JumpSize_Min        = %s , SpliceLineJumpWhiteHor_JumpSize_Max          = %s ,  "
                            "SpliceLineJumpWhiteHor_JumpSize_Field_X    = %s , SpliceLineJumpWhiteHor_JumpSize_Field_Y      = %s ,  "
                            "SpliceLineJumpBlackVer_JumpSize_Min        = %s , SpliceLineJumpBlackVer_JumpSize_Max          = %s ,  "
                            "SpliceLineJumpBlackVer_JumpSize_Field_X    = %s , SpliceLineJumpBlackVer_JumpSize_Field_Y      = %s ,  "
                            "SpliceLineJumpBlackHor_JumpSize_Min        = %s , SpliceLineJumpBlackHor_JumpSize_Max          = %s ,  "
                            "SpliceLineJumpBlackHor_JumpSize_Field_X    = %s , SpliceLineJumpBlackHor_JumpSize_Field_Y      = %s ,  "
