...
def generate_FrameLayer01(name):
	...
	while True:
		...
		with controllers.frames.lock:
			...
			(flag_frame, encodedImage_frame) = cv2.imencode(".jpg", controllers.frames.outputVideolayer01)
...
def generate_FrameLayer02(name):
	...
	while True:
		...
		with controllers.frames.lock:
			...
			# encode the frame in JPEG format
			(flag_frame, encodedImage_frame) = cv2.imencode(".jpg", controllers.frames.outputVideolayer02)
...
def generate_FrameLayer03(name):
	...
	while True:
		...
		with controllers.frames.lock:
			...
			# encode the frame in JPEG format
			(flag_frame, encodedImage_frame) = cv2.imencode(".jpg", controllers.frames.outputVideolayer03)
...
def generate_FrameLayer04(name):
	...
	while True:
		...
		with controllers.frames.lock:
			...
			# encode the frame in JPEG format
			(flag_frame, encodedImage_frame) = cv2.imencode(".jpg", controllers.frames.outputVideolayer04)
...
def generate_FrameLayer05(name):
	...
	while True:
		...
		with controllers.frames.lock:
			...
			# encode the frame in JPEG format
			(flag_frame, encodedImage_frame) = cv2.imencode(".jpg", controllers.frames.outputVideolayer05)
