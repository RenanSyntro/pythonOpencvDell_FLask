...
def init_app(app):
    ...
    def index():
        ...
        if request.method == "POST":
            ...
            if (request.form.get("trackbar_TamMinLv") != None):
                if (controllers.adjustmentPanel.varTrackbar_TamMinLv            !=	int(request.form.get("trackbar_TamMinLv"))):
                    controllers.adjustmentPanel.varTrackbar_TamMinLv            =	int(request.form.get("trackbar_TamMinLv"))
                elif (controllers.adjustmentPanel.varTrackbar_TamMinLv          != int(request.form.get("number_TamMinLv"))):
                    controllers.adjustmentPanel.varTrackbar_TamMinLv            =	int(request.form.get("number_TamMinLv"))
            ...
            if (request.form.get("trackbar_TamMaxLv") != None):
                if (controllers.adjustmentPanel.varTrackbar_TamMaxLv            !=	int(request.form.get("trackbar_TamMaxLv"))):
                    controllers.adjustmentPanel.varTrackbar_TamMaxLv            =	int(request.form.get("trackbar_TamMaxLv"))
                elif (controllers.adjustmentPanel.varTrackbar_TamMaxLv          != int(request.form.get("number_TamMaxLv"))):
                    controllers.adjustmentPanel.varTrackbar_TamMaxLv            =	int(request.form.get("number_TamMaxLv"))
            ...
            if (request.form.get("trackbar_TamMinLh") != None):
                if (controllers.adjustmentPanel.varTrackbar_TamMinLh            !=	int(request.form.get("trackbar_TamMinLh"))):
                    controllers.adjustmentPanel.varTrackbar_TamMinLh            =	int(request.form.get("trackbar_TamMinLh"))
                elif (controllers.adjustmentPanel.varTrackbar_TamMinLh          != int(request.form.get("number_TamMinLh"))):
                    controllers.adjustmentPanel.varTrackbar_TamMinLh            =	int(request.form.get("number_TamMinLh"))
            ...
            if (request.form.get("trackbar_TamMaxLh") != None):
                if (controllers.adjustmentPanel.varTrackbar_TamMaxLh            !=	int(request.form.get("trackbar_TamMaxLh"))):
                    controllers.adjustmentPanel.varTrackbar_TamMaxLh            = 	int(request.form.get("trackbar_TamMaxLh"))
                elif (controllers.adjustmentPanel.varTrackbar_TamMaxLh          != int(request.form.get("number_TamMaxLh"))):
                    controllers.adjustmentPanel.varTrackbar_TamMaxLh            =	int(request.form.get("number_TamMaxLh"))
            ...
            if (request.form.get("trackbar_TamMin") != None):
                if (controllers.adjustmentPanel.varTrackbar_TamMin              !=	int(request.form.get("trackbar_TamMin"))):
                    controllers.adjustmentPanel.varTrackbar_TamMin              =	int(request.form.get("trackbar_TamMin"))
                elif (controllers.adjustmentPanel.varTrackbar_TamMin            !=  int(request.form.get("number_TamMin"))):
                    controllers.adjustmentPanel.varTrackbar_TamMin              =	int(request.form.get("number_TamMin"))
            ...
            if (request.form.get("trackbar_TamMax") != None):
                if (controllers.adjustmentPanel.varTrackbar_TamMax              !=	int(request.form.get("trackbar_TamMax"))):
                    controllers.adjustmentPanel.varTrackbar_TamMax              =	int(request.form.get("trackbar_TamMax"))
                elif (controllers.adjustmentPanel.varTrackbar_TamMax            !=  int(request.form.get("number_TamMax"))):
                    controllers.adjustmentPanel.varTrackbar_TamMax              =	int(request.form.get("number_TamMax"))
            ...
            if (request.form.get("trackbar_iterations_erode") != None):
                if (controllers.adjustmentPanel.varTrackbar_iterations_erode    !=	int(request.form.get("trackbar_iterations_erode"))):
                    controllers.adjustmentPanel.varTrackbar_iterations_erode 	=	int(request.form.get("trackbar_iterations_erode"))
                elif (controllers.adjustmentPanel.varTrackbar_iterations_erode  !=  int(request.form.get("number_iterations_erode"))):
                    controllers.adjustmentPanel.varTrackbar_iterations_erode 	=	int(request.form.get("number_iterations_erode"))
            ...
            if (request.form.get("trackbar_iterations_dilate") != None):
                if (controllers.adjustmentPanel.varTrackbar_iterations_dilate   !=	int(request.form.get("trackbar_iterations_dilate"))):
                    controllers.adjustmentPanel.varTrackbar_iterations_dilate 	=	int(request.form.get("trackbar_iterations_dilate"))
                elif (controllers.adjustmentPanel.varTrackbar_iterations_dilate !=  int(request.form.get("number_iterations_dilate"))):
                    controllers.adjustmentPanel.varTrackbar_iterations_dilate 	=	int(request.form.get("number_iterations_dilate"))
            ...
            if (request.form.get("trackbar_LineHorizontal") != None):
                if (controllers.adjustmentPanel.varTrackbar_LineHorizontal      !=	int(request.form.get("trackbar_LineHorizontal"))):
                    controllers.adjustmentPanel.varTrackbar_LineHorizontal 	    =	int(request.form.get("trackbar_LineHorizontal"))
                elif (controllers.adjustmentPanel.varTrackbar_LineHorizontal    !=  int(request.form.get("number_LineHorizontal"))):
                    controllers.adjustmentPanel.varTrackbar_LineHorizontal 	    =	int(request.form.get("number_LineHorizontal"))
            ...
            if (request.form.get("trackbar_LineVertical") != None):
                if (controllers.adjustmentPanel.varTrackbar_LineVertical        !=	int(request.form.get("trackbar_LineVertical"))):
                    controllers.adjustmentPanel.varTrackbar_LineVertical 	    =	int(request.form.get("trackbar_LineVertical"))
                elif (controllers.adjustmentPanel.varTrackbar_LineVertical      !=  int(request.form.get("number_LineVertical"))):
                    controllers.adjustmentPanel.varTrackbar_LineVertical 	    =	int(request.form.get("number_LineVertical"))
            ...
            if (request.form.get("trackbar_LineRange") != None):
                if (controllers.adjustmentPanel.varTrackbar_LineRange           !=	int(request.form.get("trackbar_LineRange"))):
                    controllers.adjustmentPanel.varTrackbar_LineRange 	        =	int(request.form.get("trackbar_LineRange"))
                elif (controllers.adjustmentPanel.varTrackbar_LineRange         !=  int(request.form.get("number_LineRange"))):
                    controllers.adjustmentPanel.varTrackbar_LineRange 	        =	int(request.form.get("number_LineRange"))

            if (request.form.get("trackbar_ResolutionPixMm_X") != None):
                if (controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_X           !=	float(request.form.get("trackbar_ResolutionPixMm_X"))):
                    controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_X 	        =	float(request.form.get("trackbar_ResolutionPixMm_X"))
                elif (controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_X         !=   float(request.form.get("number_ResolutionPixMm_X"))):
                    controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_X 	        =	float(request.form.get("number_ResolutionPixMm_X"))

            if (request.form.get("trackbar_ResolutionPixMm_Y") != None):
                if (controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_Y           !=	float(request.form.get("trackbar_ResolutionPixMm_Y"))):
                    controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_Y 	        =	float(request.form.get("trackbar_ResolutionPixMm_Y"))
                elif (controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_Y         !=   float(request.form.get("number_ResolutionPixMm_Y"))):
                    controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_Y 	        =	float(request.form.get("number_ResolutionPixMm_Y"))
        ...
        return render_template("base.html", 
                                    ...
                                    varTrackbar_ConstResolutionPixelMm_X = controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_X,
                                    varTrackbar_ConstResolutionPixelMm_Y = controllers.adjustmentPanel.varTrackbar_ConstResolutionPixelMm_Y,
                                    ...
                                    labelWeb_RecipeName             = controllers.adjustmentPanel.labelWeb_RecipeName									
                                    )
